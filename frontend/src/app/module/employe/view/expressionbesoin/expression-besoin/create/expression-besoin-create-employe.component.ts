...
@Component({
  selector: 'app-expression-besoin-create-employe',
  templateUrl: './expression-besoin-create-employe.component.html'
})
export class ExpressionBesoinCreateEmployeComponent extends AbstractCreateController<ExpressionBesoinDto, ExpressionBesoinCriteria, ExpressionBesoinEmployeService>  implements OnInit {
