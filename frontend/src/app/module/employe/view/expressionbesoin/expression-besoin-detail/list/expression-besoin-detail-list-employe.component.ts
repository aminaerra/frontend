...
@Component({
  selector: 'app-expression-besoin-detail-list-employe',
  templateUrl: './expression-besoin-detail-list-employe.component.html'
})
export class ExpressionBesoinDetailListEmployeComponent extends AbstractListController<ExpressionBesoinDetailDto, ExpressionBesoinDetailCriteria, ExpressionBesoinDetailEmployeService>  implements OnInit {
