...
@Component({
  selector: 'app-budget-entite-admin-list-employe',
  templateUrl: './budget-entite-admin-list-employe.component.html'
})
export class BudgetEntiteAdminListEmployeComponent extends AbstractListController<BudgetEntiteAdminDto, BudgetEntiteAdminCriteria, BudgetEntiteAdminEmployeService>  implements OnInit {
