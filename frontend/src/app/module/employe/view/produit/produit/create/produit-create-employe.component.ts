...
@Component({
  selector: 'app-produit-create-employe',
  templateUrl: './produit-create-employe.component.html'
})
export class ProduitCreateEmployeComponent extends AbstractCreateController<ProduitDto, ProduitCriteria, ProduitEmployeService>  implements OnInit {
