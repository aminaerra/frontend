...
@Component({
  selector: 'app-produit-edit-employe',
  templateUrl: './produit-edit-employe.component.html'
})
export class ProduitEditEmployeComponent extends AbstractEditController<ProduitDto, ProduitCriteria, ProduitEmployeService>   implements OnInit {
