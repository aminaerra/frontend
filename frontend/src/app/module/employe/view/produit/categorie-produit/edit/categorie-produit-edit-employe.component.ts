...
@Component({
  selector: 'app-categorie-produit-edit-employe',
  templateUrl: './categorie-produit-edit-employe.component.html'
})
export class CategorieProduitEditEmployeComponent extends AbstractEditController<CategorieProduitDto, CategorieProduitCriteria, CategorieProduitEmployeService>   implements OnInit {
