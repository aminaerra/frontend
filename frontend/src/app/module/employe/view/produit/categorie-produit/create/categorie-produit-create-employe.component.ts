...
@Component({
  selector: 'app-categorie-produit-create-employe',
  templateUrl: './categorie-produit-create-employe.component.html'
})
export class CategorieProduitCreateEmployeComponent extends AbstractCreateController<CategorieProduitDto, CategorieProduitCriteria, CategorieProduitEmployeService>  implements OnInit {
