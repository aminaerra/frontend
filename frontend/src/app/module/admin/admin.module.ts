...
import { ExpressionbesoinAdminModule } from './view/expressionbesoin/expressionbesoin-admin.module';
import { ExpressionbesoinAdminRoutingModule } from './view/expressionbesoin/expressionbesoin-admin-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    BadgeModule,
    MultiSelectModule,
  ExpressionbesoinAdminModule,
  ExpressionbesoinAdminRoutingModule,
  ProduitAdminModule,
