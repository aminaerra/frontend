...
@Component({
  selector: 'app-expression-besoin-detail-edit-admin',
  templateUrl: './expression-besoin-detail-edit-admin.component.html'
})
export class ExpressionBesoinDetailEditAdminComponent extends AbstractEditController<ExpressionBesoinDetailDto, ExpressionBesoinDetailCriteria, ExpressionBesoinDetailAdminService>   implements OnInit {
